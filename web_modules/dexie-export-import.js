                        ...
                        if (item.$types) {
                            ...
                            for (keyPath in types) {
                                ...
                                if (typeSpec && typeSpec.finalize) {
                                    b = require$$0.getByKeyPath(item, arrayType ? "$." + keyPath : keyPath);
                                                    ...
                                                    switch (_a.label) {
                                                        case 0:
                                                            if (progressCallback) {
                                                                ...
                                                                require$$0.ignoreTransaction(function () { return progressCallback(progress); });
                                                            }
                                                        ...
                                                        case 1:
                                                            ...
                                                            return [4 /*yield*/, require$$0.waitFor(TSON.finalize(tsonValues))];
                                                        case 2:
                                                            _a.sent();
                                                            _a.label = 3;
                                                        case 3:
                                                            ...
                                                            lastKey = values.length > 0 ?
                                                                require$$0.getByKeyPath(values[values.length - 1], primKey.keyPath) :
                                                                null;
                                                            return [3 /*break*/, 8];
                                                        ...
                                                        case 5:
                                                            ...
                                                            return [4 /*yield*/, require$$0.waitFor(TSON.finalize(tsonTuples))];
                                                        case 6:
                                                            _a.sent();
                                                            _a.label = 7;
                                                        case 7:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    db = new require$$0(dbExport.databaseName);
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            return [3 /*break*/, 7];
                        case 5: return [4 /*yield*/, require$$0.waitFor(jsonStream.pullAsync(CHUNK_SIZE))];
                        case 6:
                            _b.sent();
                            _b.label = 7;
...
//
require$$0.prototype.export = function (options) {
    return exportDB(this, options);
};
require$$0.prototype.import = function (blob, options) {
    return importInto(this, blob, options);
};
require$$0.import = function (blob, options) { return importDB(blob, options); };
...
export { exportDB, importDB, importInto };
